        ...
        <div class="border-b-2 border-gray-100">
            ...
            <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 py-8">
                ...
                <div class="flex flex-col items-center text-gray-100">
                    ...
                    <div class="flex flex-col items-center justify-center mt-4">
                        <div>
                            <span>{{ __('Manikchak') }}</span>
                        </div>
                        <div>
                            <span>{{ __('Malda, West Bengal')}}</span>
                        </div>
                    </div>
                </div>
                <div class="flex flex-col items-center text-gray-100">
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="flex flex-col items-center justify-center text-gray-500 text-sm py-4">
                <div>
                    ...
                    <a href="https://www.linkedin.com/in/sourav-mandal-b6b31b173/" class="text-primary hover:underline" target="_blank">
                        {{ __('Sourav') }}
                    </a>
                </div>
                <span>{{ date('M, Y') }}</span>
